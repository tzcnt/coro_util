...
// Provides coro_util::qu_mpsc_unbounded, an async MPSC unbounded linearizable
...
public:
  ...
  class aw_pull final {
    friend qu_mpsc_unbounded<ContinuationPolicy, T, Config>;
  ...
  public:
    using queue_type = qu_mpsc_unbounded;
