...
// access token bound to the generic inline continuation policy (concurrencpp does not
// support executor affinity).
...
using chan_tok =
  coro_util::chan_tok_impl<coro_util::detail::inline_continuation_policy, T, Config>;
